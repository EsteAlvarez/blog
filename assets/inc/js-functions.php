...
function blog_script()
{
    ...
    //Registrar Js
    wp_register_script('bootstrap-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js', true);
...
add_action("wp_enqueue_scripts", "blog_script", 1); //1 representa prioridad, mas alto el número = mas prioridad.